...
const OpenLoomContent = ({ post }: OpenLoomContentProps) => {
        ...
        >
          ...
          <div className="mt-12">
            ...
            <div className="flex space-x-4">
              <button 
                onClick={() => {
                  window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}&hashtag=%23openloom`, '_blank');
                }}
                className="p-2 rounded-full bg-neutral-200/15 text-white hover:bg-accent hover:text-secondary transition-colors duration-300"
              ...
              <button 
                onClick={() => {
                  window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(`${post.title} - Check out this page`)}&hashtags=openloom`, '_blank');
                }}
                className="p-2 rounded-full bg-neutral-200/15 text-white hover:bg-accent hover:text-secondary transition-colors duration-300"
...
export default OpenLoomContent; 